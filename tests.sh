...
check 0 "28 sla chpwd by root"         "root" "1231" user_chpwd sla 1231

echo "======== levels ========"

check 1 "root: sla lvl -> aaa"      "root" "1231" user_chlvl sla aaa
check 0 "root: sla lvl -> 99"       "root" "1231" user_chlvl sla 99
check 0 "sla: sla1 created"          "sla" "1231" user_add sla1 1231
check 0 "sla: sla1 chpwd"            "sla" "1231" user_chpwd sla1 234a
check 1 "sla: root chpwd"            "sla" "1231" user_chpwd root 234a
check 0 "sla: sla1 lvl -> 99"        "sla" "1231" user_chlvl sla1 99
check 1 "sla: root lvl -> 99"        "sla" "1231" user_chlvl root 99
check 0 "sla: sla lvl -> 98"         "sla" "1231" user_chlvl sla 98
check 1 "permission denied"          "sla" "1231" l sla1 user_edit1
check 1 "permission denied"         "sla1" "1231" group_del sla  user_edit
check 1 "sla: user_del"              "sla" "1231" user_del sla1
check 1 "sla1: user_del"            "sla1" "1231" user_del sla
check 0 "root: sla1 deleted"        "root" "1231" user_del sla1

echo "======== Events ========"
check 1 "new event - bad args" "sla" "1231" event_new "title\ntitle" "<body1>\nbody2"\
   "people" "route" "20121201" "20121203"
check 1 "new event - bad date1" "sla" "1231" event_new "title\ntitle" "<body1>\nbody2"\
   "people" "route" "b" "20121203" "100"
check 1 "new event - bad date2" "sla" "1231" event_new "title\ntitle" "<body1>\nbody2"\
   "people" "route" "20121201" "a" "100"
check 1 "new event - bad tags" "sla" "1231" event_new "title\ntitle" "<body1>\nbody2"\
   "people" "route" "20121201" "20121203" "a,b"

check 0 "new event by sla" "sla" "1231" event_new "title\ntitle1" "<body1>
...
check 0 "edit event by sla" "sla" "1231" event_put 1 "title\ntitle1e" "<body1_n>
body2" "people" "route" "20121201" "20121205" "1231,222"
check 0 "print event" "" "" event_print "1"

check 1 "del event 3" "sla" "1231" event_del "3"
check 1 "del event 2 - perm" "" "" event_del "2"
check 0 "del event 2" "sla" "1231" event_del "2"
