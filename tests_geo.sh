...
check 1 "02 no user" "sla@lj" "123" geo_create file comm auth 20120102 20120103 123 1,2,3 < geo.h
check 0 "03 ok-add"  "sla@lj" "" geo_create file comm auth 20120102 20120103 123 1,2,3 < user.h
...
check 1 "08 replace: not exists" "sla@lj"  "" geo_replace file1 < user.h
check 1 "09 replace: not owner"  "sla1@lj" "" geo_replace file < user.h
check 0 "10 replace: ok"         "sla@lj"  "" geo_replace file < user.h
